...
export const holidayPrice = [
  ...
  { id: 'holidayD', service: 'doba pobytu w domu', price: '260 zł' },
  { id: 'holidayDK', service: 'doba w boksie', price: '200 zł' },
];
export const extras = [
  { id: 'extrasP', service: 'odbiór pod wskazanym adresem', price: '50 zł' },
  { id: 'extrasF', service: 'karma*', price: '20 zł / doba' },
];
